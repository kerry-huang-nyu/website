      ...
      <div className="about-content">
        ...
        <div className="about-bio-card">
          ...
          <div className="about-bio-text">
            ...
            <p>
              ...
              I'm pursuing a bachelors in computer science with an interest in computer science theory and machine learning. 
        ...
        <div className="social-links-section" id="connect">
          ...
          <div className="links-grid">
            ...
            <button 
              className="social-link resume resume-modal-btn"
